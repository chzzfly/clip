---
title: Netflix Jobs
date: 2023-01-20T02:02:11.000Z
updated: 2023-01-20T02:02:11.000Z
taxonomies:
  tags:
    - LifeArt
extra:
...
伟大的娱乐刺激和灵感。它引发笑声、泪水、喘息和叹息，激发我们的情感，滋养我们的精神。自从人类学会说话以来，讲故事对我们的幸福至关重要。
...
在 Netflix，我们渴望娱乐世界ーー从任何地方创造伟大的故事，为世界各地的人们提供更多的选择和控制。为了帮助我们成功，我们创造了一种不同寻常的员工文化。这份文件是关于这种文化，以及我们如何能够作为一个团队不断改进，以便我们能够更好地为我们的成员服务。
...
我们最看重的是以高度创造性和高效的方式与有才能的人一起工作。这就是为什么我们的核心理念是人超过过程，为什么我们试图把伟大的人聚集在一起作为一个梦想的团队。当然，任何成长中的业务都需要一些流程和结构。但是通过我们以人为本的方法，我们可以在我们所做的每件事情上变得更加灵活，更有创造性和成功。

## Valued Behaviors  重视行为
...
我们相信一个公司的实际价值是由他们雇佣、奖励或者解雇的人来体现的。以下是我们最关心的具体行为和技能。如果这些价值观描述了你，以及你想与之共事的人，那么你很可能会在 Netflix 取得成功。
...
- You are proud to entertain the world  
  你以娱乐世界为荣
- You are tenacious and optimistic  你顽强而乐观
...
- You look for every opportunity to reduce complexity and keep things simple  
  你寻找每一个机会来降低复杂性，使事情变得简单
- You challenge prevailing assumptions, and suggest better approaches  
  你挑战主流的假设，并提出更好的方法
- You are flexible and thrive in a constantly evolving organization  
  在一个不断变化的组织中，你是灵活的并且能够茁壮成长

### Curiosity

- You learn rapidly and eagerly  你学得又快又急
...
谈论有价值的行为很容易，实践它们却很难。在描述勇气时，我们说，“你质疑同事的行为与这些行为不一致。”我们都努力让彼此对达到这些标准负责，特别是我们的领导人。

## Honest, Productive Feedback  诚实，有效的反馈
...
在 Netflix，积极和建设性的反馈是日常生活的一部分，而不仅仅是一个年度活动。有意义的反馈可能很难给予或接受。但是就像任何新的习惯一样，通过练习它会变得更容易。因此，我们通过指导和建立我们希望在整个公司看到的行为模式，帮助人们学会给予和接受反馈。你需要勇气和无私去问别人你可以做得更好，或者问问自己你还有什么反馈没有和同事分享。两者都依赖于信任和积极的意图，这就是为什么我们投入时间发展强大的职业关系。我们知道，这种程度的坦率对于新员工来说尤其具有挑战性，对于世界上某些地区或文化中不常有直接反馈的人来说，如果存在权力失衡的话。但是，无论是作为个人还是作为一个公司，这都是变得更强大的重要组成部分，因为它是我们梦想团队的动力。
...
一个梦想团队就是你所有的同事都在他们所做的事情上表现出色，并且高效地一起工作的团队。我们眼中的好工作场所并不是什么好福利，尽管我们有很多。这是关于投资一个梦想团队的人才谁是兴奋追求雄心勃勃的共同目标。在我们的梦之队里，我们鼓励合作，分享信息，不鼓励政治。有很多爱，也有要求很高的同龄人。这是令人兴奋的，我们如何学习最多，做我们最好的工作，提高最快，并有最大的乐趣。
...
为了帮助我们吸引和留住出色的同事，我们按照员工个人市场的最高价给他们支付薪水。这是一个真诚的估计，每个员工在当地同行公司担任类似职位时，可以获得的最高薪酬，如果需要，我们会支付多少薪酬来替换他们。一些雇员估计个人市场将迅速增长，或者是由于他们的表现，或者是由于该领域的人才短缺。对于其他人来说，由于市场条件的原因，即使他们做了大量的工作，他们的收入也可能与去年持平。
...
我们把自己塑造成一个职业运动队，而不是一个家庭。家庭就是无条件为你。梦之队就是把自己推向最好的队友，全身心地关心自己的队伍，并且知道自己可能不会永远留在队伍里。梦之队是关于表现，而不是资历或任期。教练应该确保每个球员都在自己的位置上表现出色，有效地与其他球员配合，并给予新的发展机会。这就是我们如何继续赢得冠军(娱乐世界)。与运动队不同的是，随着 Netflix 的增长，运动员的数量也在增长。我们努力培养来自发展联盟的球员，这样他们才能成为明天的明星。
...
为了加强我们的梦想团队，我们的管理者对他们的每一个人都进行了“守护者测试”: 如果一个团队成员要离开去另一家公司担任类似的职务，管理者会试图留住他们吗？那些没有通过守门员考验的球员(也就是说，他们的主教练不会争取留住他们)会得到一份慷慨的遣散费，这样我们就可以找到更适合这个位置的人ーー组建一支更好的梦之队。加入梦之队是职业生涯中最令人兴奋的事情，团队成员之间相互支持，令人难以置信。这就是为什么“你花时间帮助整个 Netflix 的同事取得成功”是一种有价值的行为。
...
管理者经常与团队中的每个成员交流，因此意外很少发生。我们也鼓励员工在任何时候向他们的经理汇报，问他们: “如果我想离开的话，你会多努力工作才能改变我的想法?”
...
梦想团队的成员需要知情的风险，这需要领导和同事的勇气和鼓励。我们有许多成功和失败，这就是我们如何学习和为什么每个人都被评估在他们的整个记录(而不是简单的错误或赌注，没有回报)。
...
忠诚是最好的稳定剂。在 Netflix 有着良好业绩记录的员工，如果他们的业绩出现短暂下滑，或者他们正在担任一个新的角色，他们可以有一定的回旋余地。同样，我们希望员工在公司可能出现的任何短期衰退中坚持使用 Netflix。也就是说，我们不相信长期忠于一个停滞不前的公司，或者只忠于一个表现良好的员工。
...
在我们的梦之队里，没有聪明的混蛋，因为他们不利于伟大的团队合作。我们坚持体面的人际交往，不管一个人有多聪明。当有能力的人在一起工作得很好时，他们会激励对方比他们单独工作时更有创造力，更有效率，最终团队更成功。
...
梦之队的成功在于效率，而不是努力工作。持续的“ b”表现，尽管努力得了“ a”，却得到了遣散费的尊重。持续的“ A”表现，即使是付出较为温和的努力，也会得到回报。当然，要成为伟人，我们大多数人必须付出相当大的努力。但是我们不能用工作时间来衡量一个人的贡献。
...
梦之队并不适合所有人。有些人更喜欢有保障的工作，选择在更注重稳定性和资历的公司工作，对绩效管理不那么严格。我们的模式最适合那些重视卓越及其提供的机会的人。
...
你在 Netflix 学到了很多东西，和令人惊叹的同事一起解决难题，这增加了你的市场价值。知道如果你离开 Netflix，其他公司会很快聘用你，这让人感到欣慰。我们认为外部面试是可以接受的，并鼓励员工与他们的经理讨论他们在这个过程中学到了什么。归根结底，你赚取丰厚收入的能力是基于你的技能和声誉，而不是你在一家公司的资历。
...
在一些公司，人们忽视地板上的垃圾，把它留给别人去捡。在其他公司，人们会弯腰捡起它，就像在家里一样。我们努力成为一家让每个人都感到有责任让我们变得更好的公司。捡垃圾是处理问题的一种比喻，无论大小，从不认为“那是别人的工作。”创造一种所有权意识有助于这种行为自然而然地发生。
...
我们的目标是激励员工，而不是管理他们。我们希望我们的团队做对 Netflix 最有利的事情。这反过来又产生了责任感、责任感和自律感，驱使我们去做伟大的工作。自由本身不是目标; 目标是创造一种强烈的关心 Netflix 的感觉，让人们做对公司最有利的事情。
...
在一些组织中，过分强调过程而缺乏自由。这些组织一开始并不是这样的，但是每次出现问题，进程的蟒蛇就会更加紧张。具体来说，许多组织在规模较小时都有自由和责任，而且每个人都互相认识。然而，随着他们的成长，他们的业务变得更加复杂，有时激情和才能的水平下降。随着这个非正式的、运转平稳的组织开始瓦解，混乱的局面出现了。在这一点上，普遍的呼声是“成长”，并增加过程，以减少混乱。随着规则和程序的激增，遵守规则的价值被赋予了更多。这个系统是防伪的，创造性思维者被告知停止质疑现状。这种类型的组织可能非常专业化，并且非常适合其业务模式。然而，在 10 到 100 年的时间里，商业模式不可避免地要发生变化，而且大多数这些公司都无法适应。
...
为了避免这种情况，我们努力工作，以保持员工的优秀，并保持我们的业务尽可能简单，因为我们的增长雄心。我们希望成为一个自律、负责任的公司，能够在没有被要求的情况下发现和解决问题。

Some examples of our unusual amounts of employee<sup data-immersive-translate-effect="1">1</sup> freedom:  
我们不寻常的员工 <sup data-immersive-translate-effect="1">1</sup> 自由度的一些例子:
...
- We share documents internally broadly and systematically, so people can read and often comment on them—including memos on each title’s performance, our strategy decisions and product feature tests. There are some leaks, but the value of highly-informed employees is much greater.  
  我们在内部广泛而系统地共享文档，这样人们就可以阅读并经常评论这些文档，包括关于每个标题的表现、我们的战略决策和产品特性测试的备忘录。有一些泄露，但高知识员工的价值要大得多。
- Our policy for travel, entertainment, gifts and other expenses is five words long: “Act in Netflix’s best interest.”  
  我们对旅行、娱乐、礼物和其他费用的政策是五个字: “以 Netflix 的最大利益行事。”
- Our vacation policy is: “Take vacation.” We don’t have any rules about how many weeks per year. Frankly, we mix work and personal time quite a bit, doing email at odd hours or taking off a weekday afternoon. Our leaders make sure they set good examples by taking vacations, often coming back with fresh ideas, and encouraging the rest of the team to do the same.  
  我们的休假政策是“休假”我们没有任何关于一年有多少周的规定。坦白地说，我们经常把工作和私人时间混在一起，在非正常时间发邮件或者在工作日的下午休息。我们的领导者确保他们通过休假树立好的榜样，经常带着新的想法回来，并鼓励团队的其他成员也这样做。
- Our parental leave policy is: “Take care of your baby and yourself.” Parents generally follow local norms.  
  我们的育儿假政策是: “照顾好你的孩子和你自己。”父母通常遵循当地的规范。
...
你可能认为这么多的自由会导致混乱。相反，在过去的 25 年里，它创造了一种极其成功的商业模式。教训是你不需要什么都有政策。没有他们，你也可以创新。当我们不能将自由与强烈的责任感结合起来时，自由能够(而且确实)导致混乱。这就是为什么自由和责任是相辅相成的。
...
自由也不意味着你的经理不参与你的工作。从领导、同事或直接下属那里获得信息可以提高决策能力。这是另一个没有责任自由就不存在的例子。
...
我们的反规则自由哲学有几个重要的例外。我们在道德和安全问题上是严格的。例如，我们不能容忍对员工的骚扰或利用内幕信息进行交易。我们对会员的付款信息也有严格的控制。但这些都是边缘案件。
...
一般来说，我们认为自由和快速恢复比试图防止错误要好。我们从事的是创意行业，随着时间的推移，我们面临的最大威胁是缺乏创新。因此，除了安全问题之外，我们的容错能力相对较强，而且我们致力于确保任何错误预防措施都不会限制创造性和创造性的工作。如果人们有很好的判断力，迅速恢复是可能的。
...
多年来，一些员工以各种不幸的方式利用了这种自由。但这些都是例外，我们尽量避免过度纠正。仅仅因为少数人滥用他们的自由并不意味着我们的其他员工不值得信任。
...
有些过程是关于提高生产力，而不是避免错误。我们做得很好的一个过程是有目的的、安排好的会议。我们提前计划一个议程，包括思考什么需要同步讨论，什么可以离线完成。我们利用这些会议相互学习，取得更多成果，而不是防止错误或批准战术决策。

## Informed Captains  通知队长
...
对于每一个重要的决定，我们确定一个知情的船长谁是他们领域的专家。他们有责任听取别人的意见，然后对正确的前进方向作出判断。我们回避委员会的决定，这会拖慢我们的速度，分散责任。这是有时具有挑战性的，而且总是很重要的是，谁是一个项目的知情队长。
...
在重大的战略问题上，船长会为持不同政见者和其他替代者提供支持，以确保他们真正了解情况。持不同意见可能很困难，这就是为什么我们努力激发讨论。通常，小组会聚在一起讨论一些话题。但是船长需要做出决定。我们不会等待共识或委员会投票，也不会推动迅速、无知的决策。小的决定可以通过电子邮件分享，而大的决定则需要一份备忘录，其中讨论各种职位以及知情的队长为什么做出那个决定。决定越大，辩论就越广泛。之后，随着影响变得更加清晰，我们反思这个决定，看看我们如何在未来做得更好。

## Disagree Then Commit  不同意就承诺
...
如果员工在一个重要的公开问题上有不同意见，他们有责任解释原因，最好是当面和书面解释。讨论澄清了不同的观点，简明扼要地写出核心问题有助于人们反思明智的道路。它还使公开和广泛地分享观点变得更加容易。知情的船长有责任欢迎、理解和考虑不同的意见(也就是为持不同意见而耕种) ，即使他们不同意。一旦知情的船长做出决定，我们希望每个人ーー包括那些持不同意见的人ーー都能作出承诺，并帮助尽可能取得成功。

## Representation Matters  代表事宜
...
我们的会员希望在屏幕上看到各种各样的故事和人物，我们的公司和领导层应该反映出这种多样性。就像我们的会员一样，我们的员工有着基于他们的背景和经验的独特视角。随着我们的成长，我们正在努力使我们的员工，供应商，幕后和屏幕上的人才更好地反映我们的会员，以便我们可以更好地娱乐世界。我们已经使我们的员工和领导层的多样性成为我们行业中最好的一些，我们将继续改进，使每个人都感到在 Netflix 有归属感。
...
娱乐世界是一个惊人的机会，也是一个挑战，因为观众有非常不同的品味和观点。因此，我们提供各种各样的电视节目和电影，其中一些可以挑衅。为了帮助会员做出明智的选择，我们提供评级，内容警告和易于使用的家长控制。

Not everyone will like—or agree with—everything on our service. While every title is different, we approach them based on the same set of principles: we support the artistic expression of the creators we choose to work with; we program for a diversity of audiences and tastes; and we let viewers decide what’s appropriate for them, versus having Netflix censor specific artists or voices.  
不是每个人都会喜欢或赞同我们的服务。虽然每个标题都不一样，但我们都基于同样的原则: 我们支持我们选择合作的创作者的艺术表达; 我们为不同的观众和品味编程; 我们让观众决定什么适合他们，而不是让 Netflix 审查特定的艺术家或声音。

As employees we support the principle that Netflix offers a diversity of stories, even if we find some titles counter to our own personal values. Depending on your role, you may need to work on titles you perceive to be harmful. If you’d find it hard to support our content breadth, Netflix may not be the best place for you.  
作为员工，我们支持 Netflix 提供多样化故事的原则，即使我们发现有些电影与我们自己的个人价值观背道而驰。根据你的角色，你可能需要处理那些你认为有害的标题。如果你发现很难支持我们的内容广度，Netflix 可能不是最适合你的地方。

## Context not Control  上下文不是控制
...
我们努力在公司内部培养良好的决策能力。我们为自己的高级经理做出的决定少而不多而感到自豪。也就是说，我们不相信放手管理。每个领导者的角色是指导、设定背景、提供建议和反馈，并对团队的工作有高度的了解。领导者可以探索不同项目的细节，而不是对小决策进行微观管理。然后，这些信息可以用来为他们的团队设置更好的环境，从而更好地做出决策。我们相信，当全公司的员工自己做决定时，Netflix 是最有效率和最具创新性的。
...
我们还相信，更少的管理层使我们更加敏捷。当领导者管理许多直接下属时，我们的“上下文不受控制”文化运作得最好，给予每个员工足够的自主权去做他们一生中最好的工作。有时，由于专业化或次规模环境，我们有较小的团队，但这些应该是例外，而不是规范。一般来说，领导者会发现六到十二个直接下属在太多层次和太少时间增加价值之间有一个很好的平衡。
...
“上下文不控制”也有一些例外。例如，当: 这是一个紧急的情况，没有足够的时间来发展和分享背景; 一个新的团队成员还没有吸收足够的背景来自信; 认识到错误的人是在决策角色(暂时的，毫无疑问) ; 或一个明确的道德或合规违背需要停止。
...
我们通过高度对齐和松散耦合来避免这种情况。我们花很多时间讨论和写下战略和背景，然后彼此信任，在没有事先批准的情况下执行战术。通常，致力于同一目标的两个小组不会知道对方活动的细节，也不会得到对方活动的认可。如果之后有什么不对劲的地方，我们就坦诚地讨论一下。我们可能会发现策略过于模糊(即上下文不充分)或者策略与商定的策略不一致。我们讨论如何在未来做得更好。
...
一个高度协调、松散耦合的工作环境的成功取决于有才能的人能够很好地协同工作，并设置有效的环境。最终，我们的目标是在增加灵活性和敏捷性的同时，扩大业务以获得更大的影响力。因此，我们寻求保持快速和灵活，即使我们成长。

## Ethical Expectations  伦理期望
...
除了日常交流中的坦诚，我们行为端正，即使没有人注意到。我们使用的一个测试是询问如果我们的行为被公之于众，我们是否会感到羞耻ーー避免做任何回答是肯定的事情。
...
另外，我们有许多信息需要保密，因为这些信息具有商业敏感性。我们希望所有员工都能保护公司的机密信息，不管这些信息是否被标记为“机密”。
...
Netflix 每年向世界各地有价值的事业捐赠数千万美元。我们通过一个二对一的员工匹配来代替领导挑选特定的原因。当一个员工向一个慈善组织捐款时，Netflix 会向同一组织捐款两倍于此的金额。这使我们的捐赠决定民主化，并激励员工支持他们所热衷的事业。
...
我们不寻求保存我们的文化ーー我们寻求改进它。每一个新员工都有助于企业文化的形成和发展，这样我们就能找到新的方式来共同完成更多的工作。我们学习的速度比以往任何时候都快，因为我们拥有更多专注的人，拥有更多不同的视角，努力成为优秀的梦之队。
...
这种文化卓越推动我们的业务卓越，这增加了会员的满意度，进而推动我们的长期增长和股票价格。这是我们如何建立一个非常成功的公司娱乐世界。

## Summary

As we wrote in the beginning, what is special about Netflix is how much we:  
正如我们一开始所写的，Netflix 的特别之处在于我们:
...
最后，《小王子》(The Little Prince)一书的作者安托万·德圣埃克絮佩里为我们指明了道路:

> #### \_If you want to build a ship,
>
> 如果你想造船,\_
>
> #### _don't drum up the people  不要鼓动人民_
>
> #### _to gather wood, divide the  收集木材，分割_
>
> #### _work, and give orders.  工作，发号施令。_
>
...
<sup data-immersive-translate-effect="1">1</sup> 主要针对我们的受薪雇员; 由于法律要求，对我们的小时雇员有这方面的限制。
